...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    <header>
      <a href="/"><svg style="margin:  10px" width="52px" height="52px" viewBox="0 0 52 52" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <g fill="#fff">
    ...
    <div class="main-container" >
      <aside class="sidebar">
        <div class="inner-text">{{$color->category->name}}</div>
      </aside>
      <main class="content">
        <div id="color-detail">
